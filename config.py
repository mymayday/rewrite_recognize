...
configer.splitmode = 'split_{}x{}_4'.format(configer.dsize[0], configer.dsize[1])
...
if configer.datatype == 'Multi':
    ...
    configer.usedChannels =[770,850,730,810,890,750,790,830,870,910,930,950,710,990,970,690,670,650,590]
